...
import { ManagerLoginAction } from '../../Redux/Action/ManagerLoginAction';
...
function LoginManager(props) {
    ...
    const loginClickHandler = (e) => {
        ...
        e.preventDefault();
        dispatch(ManagerLoginAction(loginState));
    }

    return (

        <div class="container-fluid">
            {userSignIn ? <Redirect to="/profile/manager" /> : ""}
            <div class="row">
                <div class="col-lg-7 form-block px-4">
                    <div class="col-lg-8 col-md-6 col-sm-8 col-xs-12 form-box">
                       
                        <h1 class="display-6 text-center text-white mb-4 mt-4">Manager Login</h1>
                        <form>

                            <div class="form-input">
                                <span><i class="fas fa-user-alt"></i></span>
                                <input type="text" name="" placeholder="Manager Email" tabindex="10" required
                                    onChange={
                                        (e) => {
                            ...
                            <Link className="nav-link text-white text-decoration-underline" to="/managerregister">Register here</Link>
                            </div>
                        </form>
                    </div>
                </div>
